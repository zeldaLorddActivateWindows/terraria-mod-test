...
namespace TDOT.Content.Items.Weapons
{
	public class WoodenBall : ModItem
	{
		...
		{
			DisplayName.SetDefault("Wooden Ball"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
			Tooltip.SetDefault("No it's not dirt");
		}
		...
		public override void SetDefaults()
		{
			...
			Item.knockBack = 6;
			Item.value = 1;
			Item.shoot = ModContent.ProjectileType<WoodenBallThrow>();
			Item.shootSpeed = 40;
			Item.autoReuse = true;
